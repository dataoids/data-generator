...
FirstNames    = './res/Names/FirstNames.txt'
MiddleNames   = './res/Names/MiddleNames.txt'
LastNames     = './res/Names/LastNames.txt'
CountyNames   = './res/Names/CountyNames.txt'
PlaceNames    = './res/Names/PlaceNames.txt'
StateNames    = './res/Names/StateNames.txt'
CountryNames  = './res/Names/CountryNames.txt'
CompanyNames  = './res/Names/CompanyNames.txt'
